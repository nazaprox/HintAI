...
REWARDED_AD_CREDITS=Decimal("5"); MAX_DAILY_REWARDED_ADS=20; STREAK_ENABLED=True; STREAK_3_DAYS=3; STREAK_3_DAYS_REWARD=Decimal("6"); STREAK_6_DAYS=6; STREAK_6_DAYS_REWARD=Decimal("12")
...
class Config:
    ...
    APP_URL=os.getenv("APP_URL","https://hintai-frontend-test.onrender.com")
    GEMINI_MODEL=GEMINI_MODEL
    COST_ANALYSIS=COST_ANALYSIS; COST_HINT=COST_HINT; COST_SOLUTION=COST_SOLUTION; COST_LEARN=COST_LEARN; REWARD_CREDITS=REWARD_CREDITS
    INITIAL_FREE_CREDITS=INITIAL_FREE_CREDITS; MAX_REQUESTS_PER_MINUTE=MAX_REQUESTS_PER_MINUTE
    MAX_IMAGE_SIZE_BYTES=MAX_IMAGE_SIZE_BYTES; MAX_PDF_SIZE_BYTES=MAX_PDF_SIZE_BYTES; ALLOWED_IMAGE_MIME_TYPES=ALLOWED_IMAGE_MIME_TYPES; ALLOWED_PDF_MIME_TYPES=ALLOWED_PDF_MIME_TYPES
    PAYMENT_ENABLED=PAYMENT_ENABLED; ADS_ENABLED=ADS_ENABLED; REWARDED_ADS_ENABLED=REWARDED_ADS_ENABLED
